/* The driverMain module acts as a buffer between the RT thread stack and the clients userspace application. Heavily modified from the example at http://www.tldp.org/LDP/lkmpg/2.6/html/x810.html */
...
#define PROC_ENTRY_FILENAME 	"fly0"
